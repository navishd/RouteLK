...
public class ScheduleAdapter extends RecyclerView.Adapter<ScheduleAdapter.ScheduleViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ScheduleViewHolder holder, int position) {
        ...
        holder.tvScheduleID.setText(schedule.getId());

        holder.tvBusID.setText("Bus ID : " + schedule.getBusId());

        holder.tvRouteID.setText("Route ID : " + schedule.getRouteId());

        holder.tvDeparture.setText("Departure : " + schedule.getDepartureTime());

        holder.tvArrival.setText("Arrival : " + schedule.getArrivalTime());

        holder.tvTravelDate.setText("Travel Date : " + schedule.getTravelDate());
